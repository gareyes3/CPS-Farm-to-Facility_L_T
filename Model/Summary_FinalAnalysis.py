...
Tuning_HazardLevel = [1000,10000,100000,1000000]#list(range(10000,130000,10000))
...
sns.lmplot(x="GrabNo", y="value", hue="SampSize", data= Main_Combined_GS_PRej,scatter=False)
#sns.lineplot(x="HLev", y="value", hue="SampSize", data= Main_Combined_PRej)
