...
Tuning_SampleSize =[60,120,300] #[60,120,300,600,1200] #list(range(100,1200,200))
...
Tuning_Contamination_levels = [CFU_10000g,CFU_1000g,CFU_100g,CFU_10g,CFU_g]
...
g = sns.FacetGrid(Combined_df_Probs, col="SampType", hue = "SampMass",col_wrap=3, height = 6)
...
H = sns.catplot(x="ContLevel", y="PH_CFU_PerA" ,
                col="SampType", col_wrap=3,hue="SampMass",data=Combined_df_Probs, kind = "point", height = 7)
