...
data_contprog = {"Initial":Listz.List_Initial_CFU,
                 "Before PHS": Listz.List_BPHS_CFU,
                 "After PHS": Listz.Total_CA_PH,
                 "Before HS":Listz.List_BHS_CFU,
                 "After HS": Listz.Total_CA_H,
                 "Before RS": Listz.List_BRS_CFU,
                 "After RS": Listz.Total_CA_R,
                 "After VA": Listz.List_AVA_CFU,
                 "Before FPS": Listz.List_BFPS_CFU,
                 "FinalCont": Listz.Total_CA_FP
                 }
...
if (ScenCondz.H_Sampling ==1) and (ScenCondz.HS_Trad==1):
        #Sampling only in Pre-Harvers
    Out_HTr_PercRej = Listz.List_Cont_PercRej_PH #Percentage of CFU Rejected from total
...
if (ScenCondz.H_Sampling ==1) and (ScenCondz.HS_Agg==1):
    #Sampling only in Pre-Harvers
    Out_HAgg_PercRej = Listz.List_Cont_PercRej_PH #Percentage of CFU Rejected from total
...
if (ScenCondz.FP_Sampling ==1) and (ScenCondz.FPS_Trad==1):
    ...
    #Sampling only in Pre-Harvers
    Out_FPTr_PercRej = Listz.List_Cont_PercRej_PH #Percentage of CFU Rejected from total
...
if (ScenCondz.FP_Sampling ==1) and (ScenCondz.FPS_Agg==1):
    #Sampling only in Pre-Harvers
    Out_FPAgg_PercRej = Listz.List_Cont_PercRej_PH #Percentage of CFU Rejected from total
