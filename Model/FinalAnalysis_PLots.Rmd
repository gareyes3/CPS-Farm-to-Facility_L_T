...
Reading in the data
```{r}
Powers<-read.csv("Data_Tomato_Outputs/Powers_Out111.csv")
```
...
Powers$Cont<-factor(Powers$Cont,levels=c("100%", "10%", "1%", "0.10%"))
```
...
Powers_Summary$Cont<-factor(Powers_Summary$Cont,levels=c("100%", "10%", "1%", "0.10%"))
